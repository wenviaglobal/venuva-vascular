    ...
    <section className="py-32 bg-hospital-soft-blue text-center overflow-hidden border-t border-hospital-light-blue/30">
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-hospital-sky-blue font-black tracking-[0.4em] uppercase text-[10px] mb-8">
            Take the first step
          </p>
          ...
          <motion.button 
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.95 }}
            className="bg-hospital-amber text-white px-12 py-6 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-2xl hover:bg-hospital-navy transition-all"
          >
            {finalCTA.cta}
          </motion.button>
        </motion.div>
