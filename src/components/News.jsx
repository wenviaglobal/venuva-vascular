          ...
          {news.posts.map((post, idx) => (
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center">
                <p className="text-hospital-sky-blue text-xs font-bold mb-2 uppercase tracking-wide">
                ...
                <div className="flex gap-4 text-sm text-[#475569]">
                  <span className="flex items-center gap-1"><Eye className="w-4 h-4 text-hospital-sky-blue" /> {post.views}</span>
