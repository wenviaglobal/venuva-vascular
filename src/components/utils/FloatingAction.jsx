        ...
        {isVisible && (
          <>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="p-3 sm:px-6 sm:py-4 bg-[#25D366] text-white rounded-full shadow-2xl flex items-center justify-center gap-0 sm:gap-3 hover:bg-[#128C7E] transition-all group"
            >
              <svg 
                viewBox="0 0 24 24" 
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              className="bg-hospital-teal text-white p-3 sm:px-6 sm:py-4 rounded-full shadow-2xl flex items-center justify-center gap-0 sm:gap-3 hover:bg-hospital-navy transition-all group"
            >
              <Phone size={20} fill="currentColor" className="group-hover:rotate-12 transition-transform" />
              <span className="hidden sm:inline font-black text-xs uppercase tracking-widest">Call Us</span>
            </motion.a>
          </>
        )}
      </AnimatePresence>
