    ...
    <section className="py-16 bg-hospital-soft-blue overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        >
          ...
          <p className="text-hospital-charcoal font-medium text-lg max-w-2xl mx-auto">
            ...
            {reviewsData.reviews.map((review, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`absolute w-full max-w-[400px] p-8 md:p-10 bg-white rounded-[40px] shadow-2xl border border-hospital-soft-blue cursor-pointer transition-shadow hover:shadow-hospital-teal/10`}
                >
                  <div className="flex items-center gap-4 mb-8">
                    <div className="w-14 h-14 rounded-full overflow-hidden bg-hospital-soft-blue border-2 border-hospital-teal/20">
                  ...
                  <div className="relative mb-8">
                    <Quote className="absolute -top-4 -left-4 text-hospital-mint w-12 h-12 -z-10" />
                    <p className="text-slate-600 font-medium text-lg leading-relaxed text-left italic">
                      "{review.content}"
                    </p>
                  </div>

                  <div className="flex items-center justify-between pt-6 border-t border-hospital-soft-blue">
